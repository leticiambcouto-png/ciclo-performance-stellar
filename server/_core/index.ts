...
async function startServer() {
  ...
  // Trust the Manus reverse proxy so req.protocol reflects HTTPS correctly
  // This ensures cookies are set with Secure + SameSite=None in production
  ...
  // Excel export route (before tRPC)
